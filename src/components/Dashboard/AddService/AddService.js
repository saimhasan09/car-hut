...
const AddService = () => {
    ...
    const onSubmit = data => {
        ...
        const url = `https://boiling-island-95880.herokuapp.com/addService`;
        fetch(url, {
            method: 'POST',
            headers: {
    ...
    return (
        <section className='row'>
            ...
            <div className="col-md-9 m-2">
                <h3 className='text-primary p-2'>Add Car</h3> <hr />
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="row">
                        <div className="col-md-3">
                            <h6 className='text-primary'>Car Name</h6>
